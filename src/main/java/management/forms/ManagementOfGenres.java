...
public class ManagementOfGenres extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Gestionarea genurilor cărtilor");
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        if(!genreName.trim().isEmpty()){
            if(Genre.addGenre(id, genreName) > 0){
                JOptionPane.showMessageDialog(this, "Genul a fost adăugat.");
                clearTable();
                setTableModel();
            }else{
                JOptionPane.showMessageDialog(this, "Eroare de adăugare a genului."); 
            }
        }else{
